            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='chanpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="农产品库存" prop="chanpinKucunNumber">
                        <el-input v-model="chanpinForm.chanpinKucunNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='chanpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="农产品热度" prop="chanpinClicknum">
                        <el-input v-model="chanpinForm.chanpinClicknum"
                                  placeholder="农产品热度" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="农产品热度" prop="chanpinClicknum">
                            <el-input v-model="ruleForm.chanpinClicknum"
                                      placeholder="农产品热度" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
