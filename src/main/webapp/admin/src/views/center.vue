  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='zhongzhihu'"  label='种植户姓名' prop="zhongzhihuName">
               <el-input v-model="ruleForm.zhongzhihuName"  placeholder='种植户姓名' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
             <el-form-item v-if="flag=='zhongzhihu'" label='头像' prop="zhongzhihuPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='zhongzhihu'"  label='种植户手机号' prop="zhongzhihuPhone">
               <el-input v-model="ruleForm.zhongzhihuPhone"  placeholder='种植户手机号' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
           <el-form-item v-if="flag=='zhongzhihu'"  label='种植户身份证号' prop="zhongzhihuIdNumber">
               <el-input v-model="ruleForm.zhongzhihuIdNumber"  placeholder='种植户身份证号' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
           <el-form-item v-if="flag=='zhongzhihu'"  label='邮箱' prop="zhongzhihuEmail">
               <el-input v-model="ruleForm.zhongzhihuEmail"  placeholder='邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
             <el-form-item v-if="flag=='zhongzhihu'"  label='余额' prop="newMoney">
                 <el-input v-model="ruleForm.newMoney"  placeholder='余额' disabled style="width: 100px"></el-input>
                 <!--<a id="btn-recharge" @click="chongzhi" href="javascript:void(0)">点我充值</a>-->
                 <!--<a id="btn-recharge" @click="tixian" href="javascript:void(0)">点我提现</a>-->
             </el-form-item>
...
|| flag=='zhongzhihu')"  label="性别" prop="sexTypes">
...
// 注册表 种植户 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.zhongzhihuName)&& 'zhongzhihu'==this.flag){
                             this.$message.error('种植户姓名不能为空');
                             return
                         }

                         if((!this.ruleForm.zhongzhihuPhoto)&& 'zhongzhihu'==this.flag){
                             this.$message.error('头像不能为空');
                             return
                         }

                             if( 'zhongzhihu' ==this.flag && this.ruleForm.zhongzhihuPhone&&(!isMobile(this.ruleForm.zhongzhihuPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.zhongzhihuIdNumber)&& 'zhongzhihu'==this.flag){
                             this.$message.error('种植户身份证号不能为空');
                             return
                         }

                             if( 'zhongzhihu' ==this.flag && this.ruleForm.zhongzhihuEmail&&(!isEmail(this.ruleForm.zhongzhihuEmail))){
                                 this.$message.error(`邮箱应输入邮箱格式`);
                                 return
                             }
        if((!this.ruleForm.sexTypes) && (1==2|| this.flag=='yonghu'
|| this.flag=='zhongzhihu')){
