        ...
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='chanpin'">
                    <el-form-item class="select" v-if="type!='info'"  label="农产品" prop="chanpinId">
                        <el-select v-model="ruleForm.chanpinId" :disabled="ro.chanpinId" filterable placeholder="请选择农产品" @change="chanpinChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='chanpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="农产品类型" prop="chanpinValue">
            ...
            <input id="addressId" name="addressId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单编号" prop="chanpinOrderUuidNumber">
                       <el-input v-model="ruleForm.chanpinOrderUuidNumber"
                                 placeholder="订单编号" clearable  :readonly="ro.chanpinOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="订单编号" prop="chanpinOrderUuidNumber">
                           <el-input v-model="ruleForm.chanpinOrderUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="实付价格" prop="chanpinOrderTruePrice">
                       <el-input v-model="ruleForm.chanpinOrderTruePrice"
                                 placeholder="实付价格" clearable  :readonly="ro.chanpinOrderTruePrice"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="实付价格" prop="chanpinOrderTruePrice">
                           <el-input v-model="ruleForm.chanpinOrderTruePrice"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="快递公司" prop="chanpinOrderCourierName">
                       <el-input v-model="ruleForm.chanpinOrderCourierName"
                                 placeholder="快递公司" clearable  :readonly="ro.chanpinOrderCourierName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="快递公司" prop="chanpinOrderCourierName">
                           <el-input v-model="ruleForm.chanpinOrderCourierName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="快递单号" prop="chanpinOrderCourierNumber">
                       <el-input v-model="ruleForm.chanpinOrderCourierNumber"
                                 placeholder="快递单号" clearable  :readonly="ro.chanpinOrderCourierNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="快递单号" prop="chanpinOrderCourierNumber">
                           <el-input v-model="ruleForm.chanpinOrderCourierNumber"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="订单类型" prop="chanpinOrderTypes">
                        <el-select v-model="ruleForm.chanpinOrderTypes" :disabled="ro.chanpinOrderTypes" placeholder="请选择订单类型">
                            <el-option
                                v-for="(item,index) in chanpinOrderTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="订单类型" prop="chanpinOrderValue">
                        <el-input v-model="ruleForm.chanpinOrderValue"
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    addressId: false,
                    chanpinOrderUuidNumber: true,
                    chanpinId: false,
                    yonghuId: false,
                    buyNumber: false,
                    chanpinOrderTruePrice: false,
                    chanpinOrderCourierName: false,
                    chanpinOrderCourierNumber: false,
                    chanpinOrderTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    addressId: '',
                    chanpinOrderUuidNumber: new Date().getTime(),
                    chanpinId: '',
                    yonghuId: '',
                    buyNumber: '',
                    chanpinOrderTruePrice: '',
                    chanpinOrderCourierName: '',
                    chanpinOrderCourierNumber: '',
                    chanpinOrderTypes: '',
                    insertTime: '',
                },
                chanpinOrderTypesOptions : [],
                addressOptions : [],
                chanpinOptions : [],
                yonghuOptions : [],
                rules: {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=chanpin_order_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.chanpinOrderTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`chanpinOrder/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.chanpinOrderCrossAddOrUpdateFlag = false;
                                        this.parent.search();
